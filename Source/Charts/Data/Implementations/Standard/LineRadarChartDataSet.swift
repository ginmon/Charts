...
open class LineRadarChartDataSet: LineScatterCandleRadarChartDataSet, ILineRadarChartDataSet
{
    ...
    /// The color that is used for filling the line surface area.
    private var _fillUnderColor = NSUIColor(red: 140.0/255.0, green: 234.0/255.0, blue: 255.0/255.0, alpha: 1.0)
    ...
    /// The color that is used for filling the line surface area.
    open var fillUnderColor: NSUIColor
        {
        get { return _fillUnderColor }
        set
        {
            _fillUnderColor = newValue
            fill = nil
        }
    }
    ...
    open override func copyWithZone(_ zone: NSZone?) -> Any
    {
        ...
        copy.fillUnderColor = fillUnderColor
